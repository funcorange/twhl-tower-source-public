...
#ifdef TWHLTOWER
	void			SendOnTakeDamageGameEvent(const CTakeDamageInfo& info);
#endif
...
#ifdef TWHLTOWER
	//----------------------------------------------------------------------------
	// TWHL Tower: Source base entity additions
	//----------------------------------------------------------------------------
public:
	inline virtual bool UseFarItemGlow() { return false; }
	inline virtual bool UseNearItemGlow() { return false; }
	inline virtual CBaseEntity* GetGlowProxy() { return this; }
	inline virtual bool ForceGlow() { return false; }
	inline virtual bool OverrideGlowColor() { return (GetGlowColorOverride() != color32{0, 0, 0, 0}); }
	inline void SetGlowColorOverride(color32 color) { m_colGlowColorOverride = color; }
	inline virtual color32 GetGlowColorOverride() { return m_colGlowColorOverride; }

private:
	color32 m_colGlowColorOverride;
#endif
};
