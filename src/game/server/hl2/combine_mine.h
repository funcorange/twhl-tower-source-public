...
#ifdef TWHLTOWER
	inline bool	UseNearItemGlow() OVERRIDE { return false; }
	inline bool UseFarItemGlow() OVERRIDE { return (m_bDisarmed || m_bPlacedByPlayer); }
	inline bool ForceGlow() OVERRIDE { return UseFarItemGlow(); }
#endif
