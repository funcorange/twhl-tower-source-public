...
#ifdef TWHLTOWER
//-----------------------------------------------------------------------------
// Purpose: Determine whether this tank should glow
//-----------------------------------------------------------------------------
bool CFuncTank::UseNearItemGlow()
{
	if (!IsControllable())
		return false;

	return (GetGlowProxy() != NULL);
}


//-----------------------------------------------------------------------------
// Purpose: Get model entity to show glow effect on
//-----------------------------------------------------------------------------
CBaseEntity* CFuncTank::GetGlowProxy()
{
	CBaseEntity* pParent = GetParent();
	...
	return pParent->GetBaseAnimating();
}
#endif
