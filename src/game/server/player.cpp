...
public:
	...
	void InputStripWeaponsAndArmor(inputdata_t& data);

	void StripWeapons(inputdata_t &data, bool stripSuit);
	void StripWeapons(inputdata_t& data, bool stripSuit, bool stripArmor);
	DECLARE_DATADESC();
};
...
BEGIN_DATADESC( CStripWeapons )
	...
	DEFINE_INPUTFUNC( FIELD_VOID, "StripWeaponsAndArmor", InputStripWeaponsAndArmor ),
END_DATADESC()
...
void CStripWeapons::InputStripWeaponsAndArmor(inputdata_t& data)
{
	StripWeapons(data, false, true);
}
...
void CStripWeapons::StripWeapons(inputdata_t& data, bool stripSuit, bool stripArmor)
{
	CBasePlayer* pPlayer = NULL;
