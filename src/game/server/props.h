...
public:
	...
	color32	GetGlowColorOverride() OVERRIDE;

	void	InputEnableFarGlow(inputdata_t& inputdata);
	void	InputDisableFarGlow(inputdata_t& inputdata);
	void	InputSetGlowColorOverride(inputdata_t& inputdata);
#endif
...
#ifdef TWHLTOWER
	bool	UseNearItemGlow() OVERRIDE { return CBasePlayer::CanPickupObject(this, 35, 128); }
#endif
