...
#ifdef TWHLTOWER
public:
	inline bool		UseNearItemGlow() OVERRIDE { return (GetGlowProxy() != NULL); }
	inline bool		UseFarItemGlow() OVERRIDE { return UseNearItemGlow(); }
	CBaseEntity*	GetGlowProxy() OVERRIDE;

private:
	string_t m_iszGlowProxyName;	// Name of model entity to glow for this brush
#endif
};
